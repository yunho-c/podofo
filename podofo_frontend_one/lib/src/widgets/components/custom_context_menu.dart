...
class DesktopSelectableRegionContextMenu extends StatelessWidget {
    ...
    return TapRegion(
      child: ShadcnUI(
        child: ContextMenuPopup(
          ...
          position: selectableRegionState.contextMenuAnchors.primaryAnchor +
...
class MobileSelectableRegionContextMenu extends StatelessWidget {
  final BuildContext anchorContext;
  final SelectableRegionState selectableRegionState;
  final List<ContextMenuButtonItem> buttonItems;
